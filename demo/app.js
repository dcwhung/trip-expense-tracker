...
const K = {
  entries:  'tripspend.demo.entries.v1',
  topups:   'tripspend.demo.topups.v1',
  settings: 'tripspend.demo.settings.v1',
  sticky:   'tripspend.demo.sticky.v1',
  backup:   'tripspend.demo.lastBackup.v1',
  banner:   'tripspend.demo.bannerDismissed.v1',
};
